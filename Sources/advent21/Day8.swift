...
class Task16: Task {
    ...
    func decoder(_ code: [[String.Element]]) -> Int {
        ...
        d[3] = code.first { $0.count == 5 && cont($0, d[1]) == 0 }
        d[5] = code.first { $0.count == 5 && cont($0, d[1]) == 1 && cont($0, d[4]) == 1 }
        d[2] = code.first { $0.count == 5 && cont($0, d[3]) != 0 && cont($0, d[5]) != 0 }
        d[6] = code.first { $0.count == 6 && cont($0, d[1]) == 1 }
        d[9] = code.first { $0.count == 6 && cont($0, d[4]) == 0 }
        d[0] = code.first { $0.count == 6 && cont($0, d[4]) == 1 && cont($0, d[1]) == 0 }
